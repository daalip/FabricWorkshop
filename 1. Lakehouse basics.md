...
Naviagte to the "Model layouts" in the "Explorer" section. Locate the vwThermostatReadings table and click on the elipsis to the right of the table name. 

Select the "New Measure" button from the dropdown menu. This allows you to create a new DAX measure from the SQL user interface.
...
Scroll down to the bottom of the vwThermostatReadings table and note that "Average Temperature" has been added to the table.
